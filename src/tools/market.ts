...
export function createMarketTools(binanceClient: BinanceClient): Tool[] {
  return [
    {
...
export async function handleMarketTool(name: string, args: any, binanceClient: BinanceClient): Promise<any> {
